            ...
            <table class="table table-striped">
                ...
                <tbody>
                    ...
                    <tr>
						...
						<td>
							<button onclick="location.href='admin_view_jobs_more.php?job_title=<?php echo $row[1] ?>&teacher_id=<?php echo $row[6] ?>'"class="btn btn-primary btn-md">View more info</button>
						</td>
                    </tr>
                    <?php
                    $count++;
